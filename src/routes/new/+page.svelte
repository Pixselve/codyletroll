<div class="h-screen w-screen flex items-center flex-col justify-center content-center bg-cody">
  <form on:submit|preventDefault="{submit}" class="p-5 space-y-5">
    ...
    <div>
      ...
      <input required name="text1" class="bg-gray-200 border border-gray-300 p-4 rounded-lg  w-full "
             bind:value={form_data.textMainContent} type="text">
    </div>

    <div>
      <label for="text2" class="font-bold">Texte secondaire</label>
      <input required name="text2" class="bg-gray-200 border border-gray-300 p-4 rounded-lg  w-full "
    ...
    <div>
      ...
      <input required name="color1" class="bg-gray-200 border border-gray-300 p-1 rounded-lg w-full h-10"
             bind:value={form_data.textMainColor} type="color">
    </div>

    <div>
      <label for="color2" class="font-bold">Couleur texte secondaire</label>
      <input required name="color2" class="bg-gray-200 border border-gray-300 p-1 rounded-lg w-full h-10"
    ...
    <div>
      ...
      <input required name="bg" class="bg-gray-200 border border-gray-300 p-1 rounded-lg w-full h-10"
    ...
    <div>
      ...
      <input required name="img" class="bg-gray-200 border border-gray-300 p-4 rounded-lg  w-full "
             bind:value={form_data.imageURL} type="text">
    </div>

    <div>
      <label for="title" class="font-bold">Titre de la page</label>
      <input required name="title" class="bg-gray-200 border border-gray-300 p-4 rounded-lg  w-full "
             bind:value={form_data.title} type="text">
    </div>

    <div>
      <label for="description" class="font-bold">Description de la page</label>
      <input required name="description" class="bg-gray-200 border border-gray-300 p-4 rounded-lg  w-full "
             bind:value={form_data.description} type="text">
    </div>

    <div>
      <label for="ogImage" class="font-bold">OG Image (Optionnel)</label>
      <input name="ogImage" class="bg-gray-200 border border-gray-300 p-4 rounded-lg  w-full "
             bind:value={form_data.ogImage} type="text">
    </div>

    <div>
      <div class="form-check">
        <input bind:group={form_data.music}
