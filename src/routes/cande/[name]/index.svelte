...
{#if isDoorOpened}
  <main class="reveal">
    ...
    <div class="title">{name} vous a Candisé !</div>
    <div class="subtitle">Tu veux être ma lampe de chevet ? Pour que je t'allume tous les soirs</div>


    <img class="cody-face" src="cande/avatar.png" alt="">
  </main>
{:else}
  <main class="doorBackground">
    <Door color="#A826D7" on:click={openDoor}/>
  </main>
{/if}
